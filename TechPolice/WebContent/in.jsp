	...
	<table align="center"><tr><td>Law &amp; Order Automation</td></tr></table>
		<div class="rain">
			...
			<div class="border start">
				...
				<img src="images/sc.png" width="62" height="58"></img></td><td><label  for=heading><font color=white><a href="in.jsp">
<h3>Police Login</h3></a></font></label></td></tr><tr><td></td><td><label><center><font color=red>
<%
