				...
				<tr>
					...
					<td width="100%" valign="top">
						<table width="100%" cellpadding="6"  cellspacing="6">
							...
							db.connect();
							db.updateSQL("update sakansha.arms set status=2,approved_by="+session.getAttribute("id")+",approved_on=current_timestamp,comments='NOT Accepted',rejection='Yes' where arms_id="+request.getParameter("idd"));
								%>
		<jsp:forward page="checklicense.jsp?err=Reject In Arms License"></jsp:forward>
								<%
							db.close();
							}
							catch(Exception e)
